...
public class PlacementCheckNonPath implements PlacementStrategy {

    /**
     * Checks whether a building is able to be placed a specified spot based on the criteria that the spot is not on the path
