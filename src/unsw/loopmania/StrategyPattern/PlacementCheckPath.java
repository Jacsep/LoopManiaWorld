...
public class PlacementCheckPath implements PlacementStrategy {

    /**
     * Checks whether a building is able to be placed a specified spot based on the criteria that the spot is on the path
